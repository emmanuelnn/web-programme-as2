...
<html>
	...
	<?php
		...
		?>
			...
			$manufacturers = $pdo->query('SELECT * FROM manufacturers');

			foreach ($manufacturers as $manufacturers) {
				echo '<tr>';
				echo '<td>' . $manufacturers['name'] . '</td>';
				echo '<td><a style="float: right" href="editmanufacturer.php?id=' . $manufacturers['id'] . '">Edit</a></td>';
