...
<html>
	...
	if (isset($_POST['submit'])) {
		...
		$stmt = $pdo->prepare('INSERT INTO cars (name, description, price, mileage, engine_type, manufacturerId) 
							   VALUES (:model, :description, :price, :mileage, :engine_type, :manufacturerId)');
		...
		?>
			...
			<form action="addcar.php" method="POST" enctype="multipart/form-data">
				...
				<label>mileage</label>
				<input type="text" name="mileage" value="<?=$cars['mileage'] ?? ''?>" />

				<label>Engine Type</label>
				<input type="text" name="engine_type" value="<?=$cars['engine_type'] ?? ''?>" />
